---
title: 'WSL2上のNext.jsアプリにLAN内スマホからHTTPSでアクセスする環境構築'
emoji: '📱'
type: 'tech'
...
ミニアプリなどネイティブアプリのアプリ内ブラウザ (WebView) 上にWebアプリを表示するサービスを開発する際、開発PC上でブラウザ表示するだけでは動作確認できないことがあります。
この場合、コード更新の結果をすぐに確認するために、スマートフォン実機から開発PCのローカル開発環境にアクセスして動作確認したいと思います。
...
この記事では、**WSL2上で動作するNext.jsアプリに対して、LAN内のスマートフォンからHTTPSで簡単にアクセスする方法**を解説します。
